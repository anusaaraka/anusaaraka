...
echo "<frame src="\"$1"_eng_align1.html\"" " name=\"English\"\>" >> $2/$1_frame1.html       #changed this
...
python3 $HOME_anu_test/miscellaneous/html_debugging/this.py $2/$3.txt.html $2 $1 #added this
