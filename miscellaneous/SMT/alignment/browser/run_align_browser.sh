...
#Replacing SYMBOL-NAME with its original SYMBOL. Added by Roja(18-10-12)
 ...
 sed 's/@SYMBOL/SYMBOL/g'  $3/tmp/$2_tmp/$2_align_tmp3.html | sed 's/ \///g'  | sed "s/\([_>'\"]\)SYMBOL/\1 SYMBOL/g" | sed "s/SYMBOL-\([A-Z\-]*\)/SYMBOL-\1 /g"  | sed 's/^SYMBOL/ SYMBOL/g' | sh $3/tmp/$2_tmp/Symbols.sh > $3/tmp/$2_tmp/$2_align_tmp4.html
