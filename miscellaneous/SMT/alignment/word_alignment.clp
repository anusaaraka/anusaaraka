...
=>
	...
	(assert (anu_id-a_grp_mng-sep-manual_id-m_grp_mng  ?aid $?a $?a1 - ?mid $?m))
	(modify ?f2 (group_ids $?d $?d1))
)

(defrule get_Ora_align
(declare (salience 5))
(anu_id-anu_mng-sep-man_id-man_mng ?a_h Ora - ?a_h Ora)
...
(not (anu_id-a_grp_mng-sep-manual_id-m_grp_mng ?h $?))
