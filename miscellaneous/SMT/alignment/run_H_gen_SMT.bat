...
; (save-facts "id_Apertium_output_new.dat" local id-Apertium_output)
 ...
 (load-facts "lwg_info.dat")
 (run)
 (save-facts "database_mng.dat" local id-org_wrd-root-dbase_name-mng e_tam-id-dbase_name-mng) 
 (clear)
 ;--------------------------------------------------------------------------
; (load "global_path.clp")
...
; (clear)
 ;--------------------------------------------------------------------------
 (load "global_path.clp")
 (bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/alignment/man_noun_lwg.clp"))
 (load ?*path*)
 (load-facts "manual_word.dat")
 (run)
 (save-facts "noun_lwg.dat" local manual_id-word-cat)
