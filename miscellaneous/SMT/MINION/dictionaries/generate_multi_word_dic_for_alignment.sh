...
$HOME_anu_test/Anu_src/converting-dic-to-alignment_format.out  hnd_multi2  > hnd_$2
fi
rm -f eng hnd hnd_new eng_multi eng_multi1 hnd_multi hnd_multi1 hnd_multi2
