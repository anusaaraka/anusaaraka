...
;---------------------------------------------------------------------------------------
(load "global_path.clp")
(bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/MINION/alignment/get_minion_aligned_mngs_info.clp"))
(load ?*path*)
...
(save-facts "left_out_info.dat" local left_out_mngs left_out_words)
(clear)
;---------------------------------------------------------------------------------------
;(load "global_path.clp")
;(bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/MINION/alignment/get_mng.clp"))
;(load ?*path*)
;(load-facts "left_out_info.dat")
;(load-facts "word_alignment_tmp.dat")
