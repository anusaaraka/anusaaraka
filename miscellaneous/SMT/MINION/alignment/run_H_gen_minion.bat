...
; (clear)
 ;--------------------------------------------------------------------------
 (load "global_path.clp")
 (bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/MINION/alignment/get_anu_grp_mng.clp"))
 (load ?*path*)
 (load-facts "id_Apertium_output.dat")
 (load-facts "hindi_meanings.dat")
 ...
 (save-facts "hindi_id_order_for_minion_tmp.dat" local hindi_id_order count_of_inserted_word-position)
 (close ap_fp)
 (close ap_grp_fp)
 (clear)
 ;--------------------------------------------------------------------------
 (load "global_path.clp")
 (bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/MINION/alignment/change_manual_id.clp"))
 (load ?*path*)
 ...
 ;--------------------------------------------------------------------------
 (load "global_path.clp")
 (bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/MINION/alignment/get_man_grp_mng.clp"))
 (load ?*path*)
...
; (load-facts "full_parser_relation.dat")
 ...
 (save-facts "shallow_parser_root_tmp2.dat" local id-node-word-root)
 ...
 (load-facts "database_mng.dat")
 (load-facts "shallow_parser_root_tmp2.dat")
 (load-facts "multi_word_expressions.dat")
 (load-facts "proper_noun_dic.dat")
 (open "man_multi_word.dat"  m_fp "w" )
 (run)
 (save-facts "manual_grouping_using_dic.txt" local manual_ids-sep-mng)
 (clear)
 ;--------------------------------------------------------------------------
 (load "global_path.clp")
 (bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/MINION/alignment/manual_lwg.clp"))
 (load ?*path*)
 (load-facts "manual_word_without_@.dat")
 (load-facts "manual_group_mng_tmp.dat")
 (load-facts "manual_ids_tmp2.dat")
 (load-facts "shallow_parser_root_tmp2.dat")
 (load-facts "word.dat")
 (run)
 (save-facts "manual_lwg_tmp.dat" local manual_id-cat-word-root-vib-grp_ids)
 (save-facts "manual_ids_tmp3.dat" local head_id-grp_ids)
 (save-facts "manual_group_mng_tmp1.dat" local manual_id-node-word-root-tam)
 (save-facts "shallow_parser_root.dat" local id-node-word-root)
 (clear)
 ;--------------------------------------------------------------------------
 (load "global_path.clp")
 (bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/MINION/alignment/modify_root_using_dic.clp"))
 (load ?*path*)
 ...
 (save-facts "manual_group_mng.dat" local manual_id-node-word-root-tam)
 (clear)
 ;--------------------------------------------------------------------------
...
; (load-facts "GNP_agmt_info.dat")
 ...
 (load-facts "revised_root.dat")
 (run)
 (save-facts "meaning_alignment_source_tmp.dat" local id-src-eng_wrds-anu_mng-man_mng)
 (clear)
 ;--------------------------------------------------------------------------
 (load "global_path.clp")
