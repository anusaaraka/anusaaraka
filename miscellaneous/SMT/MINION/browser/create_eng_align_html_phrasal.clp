...
(deftemplate parser_align (slot anu_id (default 0))(slot man_id (default 0))(multislot anu_meaning (default 0))(multislot man_meaning(default 0)))
 ...
 else (if (eq ?sen_type hindi_order_for_of) then
 ...
 (deffunction print_manual_ouput_row3(?p_id ?s_id ?w_id ?chnk_fr_htm ?l_punc ?r_punc ?man_op ?mng_src ?lwg_type)
 (printout fp "<tr class=\"row15\">" crlf )
 (if (= ?w_id 1) then (printout fp "<td class=\"number\">"?p_id"."?s_id".P</td>"))
 (if (eq ?lwg_type MAIN_VERB) then
 (printout fp "<td class=\""?chnk_fr_htm"\">  <a class=\"tooltip\" href=\"#\"> " ?man_op" <span>"?mng_src"</span></a></td>" crlf "</tr>" crlf)
 else (if (eq ?lwg_type AUX_VERB) then
 (printout fp "<td class=\""?chnk_fr_htm"\"> " ?man_op " </td>" crlf "</tr>" crlf)
 else
 (printout fp "<td class=\""?chnk_fr_htm"\"> <a class=\"tooltip\" href=\"#\"> " ?man_op " <span>"?mng_src"</span></a></td>" crlf "</tr>" crlf)))
...
;
 ...
 ;================================ Generate dummy fact for pth layer debugging ===========================
 (defrule dummy_pth_layer_debug_fact
 (declare (salience 900))
 (id-word ?id ?word)
 (not (anu_id-man_id-source ?id $?))
 =>
	(assert (anu_id-man_id-source ?id - -))
 )
...
; (test (neq ?p_id 1))
 ...
 ;---------------------------------------------------------------------------------------------------
 ;Added by Shirisha Manju 04-08-17
 ; to display group information for lwg  (( may be assigned ))
 ;;printing lwg words information
 (defrule id_rule_first_aux
 ...
 (root-verbchunk-tam-chunkids ? ? ? ?id $?lwg_ids ?head_id)
...
; (final_align (anu_id ?id)(man_meaning ?man_mng3))
 ...
 (anu_id-man_id-source ?id ? ?mmng_src)
 ...
 (print_manual_ouput_row3  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?man_mng_tmp ?mmng_src AUX_VERB)
...
; (final_align (anu_id ?id)(man_meaning ?man_mng3))
 ...
 (print_manual_ouput_row3  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?man_mng_tmp ?mmng_src MAIN_VERB)
...
; (final_align (anu_id ?id)(man_meaning ?man_mng3))
 (parser_align (anu_id ?id)(man_meaning ?man_mng4))
 (anu_id-anu_mng-sep-man_id-man_mng_tmp ?id $? ? - ? ?man_mng_tmp)
 (anu_id-man_id-source  ?id ?	 ?mmng_src ) ;tooltip for pth layer
 (id-phrase_type-lvalue ?id ?ph_ltype ?ph_l_val)
 (id-phrase_type-rvalue ?id ?ph_rtype ?ph_r_val)
 (anu_id-man_left_punc ?id ?m_l_punc)
 (anu_id-man_right_punc ?id ?m_r_punc)
 ...
 (print_manual_ouput_row3 ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?man_mng_tmp ?mmng_src -)
...
; (final_align (anu_id ?pp_id)(man_meaning ?man_mng3))
 ...
 (anu_id-man_id-source ?pp_id ? ?mmng_src)
 ...
 (print_manual_ouput_row3  ?p_id ?s_id ?pp_id ?chnk_fr_htm ?l_punc ?r_punc ?man_mng_tmp ?mmng_src -)
...
; (print_manual_ouput_row4  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?man_mng3 -)
 ...
 (print_manual_ouput_row3  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - ?mmng_src -)
