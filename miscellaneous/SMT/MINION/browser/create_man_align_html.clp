 ...
 (printout fp "<link href=\"man_eng_anu_hin.css\" type=\"text/css\" rel=\"stylesheet\" />" crlf)
 ...
 (printout fp "<script src=\"man_eng_anu_hin.js\" type=\"text/javascript\"></script>" crlf)
 ...
 (deffunction print_manual_ouput_row(?p_id ?s_id ?w_id ?chnk_fr_htm ?l_punc ?r_punc ?man_op ?lwg_type $?eng_sen)
...
; (printout fp "<table cellspacing=\"0\">"crlf"<tr class=\"row2\">" crlf)
 (if (= ?w_id 1) then (printout fp "<td class=\"number\">"?p_id"."?s_id".B</td>"))
 (printout fp "<td class=\""?chnk_fr_htm"\"> "?original_word" </td>" crlf "</tr>" crlf)
; (printout fp "<td class=\"number\">"?p_id"."?s_id".B<a name=\"sentence_"?p_id"_"?s_id"_"?w_id"\" id=\"sentence_"?p_id"_"?s_id"_"?w_id"\"></a></td><td class=\""?chnk_fr_htm"\"> <a onclick=\"javascript:  fetchshabd"?fetch"('"?root"')\"> <span id=\"popup_link_"?p_id"_"?s_id"_"?w_id"_"?original_word"\" class=\"popup_link\">"?l_punc ?original_word ?r_punc"</span> <script type=\"text/javascript\"> new Popup('popup_2','popup_link_"?p_id"_"?s_id"_"?w_id"_"?original_word "',{position:'below',trigger:'click'}); </script>   </a> </td>"crlf"</tr>" crlf)
 )
 ...
 (if (= ?w_id 1) then (printout fp "<td class=\"number\">"?p_id"."?s_id".C"))
...
; (test (neq ?p_id 1))
 (anu_id-anu_mng-sep-man_id-man_mng  ?aid  $? - 1 ?man_mng)
 (manual_ids $? ?n_words)
 (id-word ?aid ?word)
 (chunk-ids ?chunk_type ?chnk_fr_htm $?ids)
 (test (member$ ?aid $?ids))
 (id-root-category-suffix-number ?aid ?root ? ?suf ?num)
 (id-right_punctuation ?aid ?r_punc)
 (id-left_punctuation  ?aid ?l_punc )
 (id-original_word ?aid ?original_word)
 (sen_type-id-phrase ?sen_type ?aid ?)
 (Eng_sen $?eng_sen)
 =>
 (if (eq ?r_punc NONE) then (bind ?r_punc ""))
 (if (eq ?l_punc NONE) then (bind ?l_punc ""))
...
; (printout fp "<form class=\"suggestion\" action=\"sumbit_suggestions.php\"><table cellspacing=\"0\">" crlf)
 (print_manual_ouput_row  ?p_id ?s_id 1 ?chnk_fr_htm ?l_punc ?r_punc ?man_mng - $?eng_sen)
 ...
 (para_id-sent_id-no_of_words ?p_id ?s_id ?)
; (test (neq ?p_id 1))
 (anu_id-anu_mng-sep-man_id-man_mng  -  $? - 1 ?man_mng)
 (manual_ids $? ?n_words)
 (Eng_sen $?eng_sen)
 =>
 (printout fp "<form class=\"suggestion\" action=\"sumbit_suggestions.php\"><table cellspacing=\"0\">" crlf)
 (print_manual_ouput_row  ?p_id ?s_id 1 - "" "" ?man_mng - $?eng_sen)
 (print_eng_wrd_row  ?p_id ?s_id 1 - "" "" - - - -  $?eng_sen)
 (assert (id-index 1 ?n_words))
 )
 ...
 (declare (salience 1000))
 ?f<-(id-index ?mid ?n_words)
 (anu_id-anu_mng-sep-man_id-man_mng  ?id  $? - ?mid ?man_mng)
 (test (neq ?mid 1))
 (test (neq ?id -))
 ...
 (id-right_punctuation ?id ?r_punc)
 (id-left_punctuation  ?id ?l_punc )
 (sen_type-id-phrase ?sen_type ?id ?)
 (Eng_sen $?eng_sen)
 =>
 (if (eq ?r_punc NONE) then (bind ?r_punc ""))
 (if (eq ?l_punc NONE) then (bind ?l_punc ""))
 ...
 (print_manual_ouput_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?man_mng - $?eng_sen)
 (print_eng_wrd_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?root ?original_word ?sen_type ?fetch -)
 )

 (defrule sent_next_word1
 (declare (salience 999))
 ?f<-(id-index ?mid ?n_words)
 (anu_id-anu_mng-sep-man_id-man_mng -  $? - ?mid ?man_mng)
 (para_id-sent_id-no_of_words ?p_id ?s_id ?words)
 (test (neq ?mid 1))
 (Eng_sen $?eng_sen)
 =>
 ;(printout fp "<table cellspacing=\"0\">" crlf)
 ;(printout fp "<tr class=\"row1\">" crlf)
 (print_manual_ouput_row  ?p_id ?s_id ?mid U "" "" ?man_mng - $?eng_sen)
 (print_eng_wrd_row  ?p_id ?s_id ?mid U "" "" - - - -)
 )
...
; )
 ...
 (not (id_manual_output_mng_modified ?mid))
 =>
 (retract ?f)
 ...
 (if (eq ?length 0) then
        ...
        (assert (id_manual_output_mng_modified ?mid))
 )
 ...
 (print_caution_row ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?root ?sen_type ?idiom_des)
 (print_padasutra_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?cat ?padasuthra)
 (print_root_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?root ?suf ?num)
 (print_dictionary_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?cat ?root)
 (print_pos_row ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?cat)
 (print_chunker_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?chunk_type)
 (if (= ?head_id ?id) then
 (print_lwg_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_tam ?padasuthra MAIN_VERB)
 (print_sense_disambiguation_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_mng ?h_tam MAIN_VERB ?mng_src)
 (print_prep-movement_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_mng ?h_tam MAIN_VERB -)
 (print_hindi-generation_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output MAIN_VERB)
 ;(print_manual_ouput_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?man_mng MAIN_VERB)
 (print_suggestion_row ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output MAIN_VERB) 
 else
 (print_lwg_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_tam ?padasuthra AUX_VERB)
 (print_sense_disambiguation_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_mng ?h_tam AUX_VERB ?mng_src)
 (print_prep-movement_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_mng ?h_tam AUX_VERB -)
 (print_hindi-generation_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc - AUX_VERB)
 ;(print_manual_ouput_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?man_mng AUX_VERB)
 (print_suggestion_row ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output AUX_VERB)) 

 (assert (id-index (+ ?mid 1) (- ?n_words 1)))
 )
 ;---------------------------------------------------------------------------------------------------
...
; (id-root ?pp_id ?pp_root)
 ...
 (print_pos_row ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?cat)
 (print_chunker_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?chunk_type)
 (print_lwg_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc - ?padasuthra VIB0) 
 (print_sense_disambiguation_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - VIB0 ?mng_src)
 (print_prep-movement_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - VIB0 -)
 (print_hindi-generation_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output -)
 ;(print_manual_ouput_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?man_mng -)
 (print_suggestion_row ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output -)
...
; (test (neq ?pp_h_mng -))
 ...
 (anu_id-anu_mng-sep-man_id-man_mng ?pp_id $? - ?mid ?man_mng)
 =>
 (retract ?f)
 (bind ?sign (- ?id ?pp_id))
 (if (eq ?r_punc NONE) then (bind ?r_punc ""))
 ...
 (print_pos_row ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?cat)
 (print_chunker_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?chunk_type)
 (print_lwg_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc - ?padasuthra -)
 (print_sense_disambiguation_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - - ?mng_src)
 (print_prep-movement_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - - -)
 (print_hindi-generation_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output -)
 ;(print_manual_ouput_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?man_mng -)
 (print_suggestion_row ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output -)
 ...
 (print_sense_disambiguation_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - - ?mng_src)
 (print_prep-movement_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - - -)
 (print_hindi-generation_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_mng -)
 ;(print_manual_ouput_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?man_mng -)
 (print_suggestion_row ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?h_mng -)
 ...
 (print_chunker_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?chunk_type)
 (print_lwg_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc - ?padasuthra -)
 (print_sense_disambiguation_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc - - - -)
 (print_prep-movement_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc - - - -)
 (print_hindi-generation_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc - -)
 ;(print_manual_ouput_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc ?man_mng -)
 (print_suggestion_row ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc - -)
...
; (if (eq ?r_punc NONE) then (bind ?r_punc ""))
; (if (eq ?l_punc NONE) then (bind ?l_punc ""))
 (if (eq ?id -) then (bind ?id 0))
 (print_caution_row ?p_id ?s_id ?mid U "" "" - - -)
 (print_padasutra_row  ?p_id ?s_id ?mid U "" "" - -)
 (print_root_row  ?p_id ?s_id ?mid U "" "" - - -)
 (print_dictionary_row  ?p_id ?s_id ?mid U "" "")
 (print_pos_row ?p_id ?s_id ?mid U "" "" -)
 (print_chunker_row  ?p_id ?s_id ?mid U -)
 (print_lwg_row  ?p_id ?s_id ?mid U "" "" - - -)
 (print_sense_disambiguation_row  ?p_id ?s_id ?mid U "" "" - - - -)
 (print_prep-movement_row  ?p_id ?s_id ?mid U "" "" - - - -)
 (print_hindi-generation_row  ?p_id ?s_id ?mid U "" "" - -)
 ;(print_manual_ouput_row  ?p_id ?s_id ?mid ?chnk_fr_htm ?l_punc ?r_punc - -)
 (print_suggestion_row ?p_id ?s_id ?mid U "" "" - -)
...
; (defrule sent_end1
; (declare (salience 299))
; (para_id-sent_id-no_of_words ?p_id ?s_id ?n_words)
; ?f<-(anu_id-anu_mng-man_mng Construction mismatch) 
; (manual_hin_sen $?man_sen)
; (Eng_sen $?eng_sen)
; =>
; (retract ?f)
...
; (printout fp "<form class=\"suggestion\" action=\"sumbit_suggestions.php\"><table cellspacing=\"0\">" crlf)
; (printout fp "<tr class=\"row1\">" crlf)
; (printout fp "<td class=\"number\">"?p_id"."?s_id"	"(implode$ $?eng_sen)"</td></tr>" crlf)
; (printout fp "<td class=\"number\">"?p_id"."?s_id"	"(wx_utf8 (implode$ $?man_sen))"</td></tr>" crlf)
; (printout fp "</table></form>")
; (if (and (= ?p_id 1) (= ?s_id 1)) then (printout fp "<div class=\"float_clear\"/>" crlf))
; (reset)
; (bind ?path (str-cat ?p_id "." (+ ?s_id 1) "/" facts_for_eng_align_html))
