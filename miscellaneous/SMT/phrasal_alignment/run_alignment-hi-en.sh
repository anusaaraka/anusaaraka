...
python match_value_in_hnd.py  $2  $MYPATH/tmp/$3_tmp/key-val-hi-en.txt $MYPATH/tmp/$3_tmp/graph-hi-en $1 > $MYPATH/tmp/$3_tmp/match-value-hi-en.txt 
echo "Phrase alignment"
python print_shortest_path.py $MYPATH/tmp/$3_tmp/match-value-hi-en.txt  $MYPATH/tmp/$3_tmp/graph-hi-en > $MYPATH/tmp/$3_tmp/shortest-path-value-hi-en.txt
python get_phrase.py  $2  $MYPATH/tmp/$3_tmp/shortest-path-value-hi-en.txt $MYPATH/tmp/$3_tmp/left-over-words-hi-en.txt > $MYPATH/tmp/$3_tmp/align_eng-hi-en.txt
