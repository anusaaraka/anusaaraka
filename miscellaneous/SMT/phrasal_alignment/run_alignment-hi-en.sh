...
python3 map-eng-offset.py $1/key-hi-en_tmp.dat $1/map-hi-en.dat  $1/map-wrd-id-hi-en.dat >  $1/key-hi-en.dat

echo "extracting values for the given keys"   >> $1/phrasal_error
./gdbm-fetch.out  hi-en/Hin-Eng-dic_$2.gdbm  $1/key-hi-en.dat > $1/key-val-hi-en.dat

echo "searching values in hindi sentence"  >> $1/phrasal_error
python3 match_value_in_hnd.py  $1/hnd  $1/key-val-hi-en.dat $1/graph_input-hi-en $1/eng_tok_org $1/graph_output-hi-en $1/english_left_over-hi-en.dat > $1/match-value-hi-en.dat  2>> $1/phrasal_error
...
python3 $MYPATH/map-hindi-offset.py  $1/key_hindi_phrase-hi-en.dat $1/map_hindi_offsets-hi-en.dat $1/match-value-hi-en.dat > $1/match-value-with-hindi-wrdid-hi-en.dat 2>> $1/phrasal_error
...
#        echo '(NO PATH)' >> $1/phrasal_error
	...
	python3 print_shortest_path.py $1/match-value-with-hindi-wrdid-hi-en.dat  $1/graph_output-hi-en > $1/shortest-path-value-hi-en.dat  2>> $1/phrasal_error
	python3 get_phrase.py  $1/shortest-path-value-hi-en.dat  $1/hnd2 $1/left-over-words1-hi-en.dat  $1/left-over-words-hi-en.dat> $1/align_eng-hi-en.dat 2>> $1/phrasal_error
	python3 map_eng_offset-to_wrdids.py  $1/align_eng-hi-en.dat  $1/map-wrd-id-hi-en.dat > $1/mapped-hi-en.dat  2>> $1/phrasal_error
	python3  map-wrd-offset-anu-ids.py $1/mapped-hi-en.dat   > $1/mapped-1-hi-en.dat  2>> $1/phrasal_error
	echo "Word alignment" >> $1/phrasal_error
	python3 get_word_align.py hi-en/Word-to-word-hi-en_$2.txt   $1/mapped-hi-en.dat $1/hnd2 $1/left-hi-en  $1/left1-hi-en > $1/wrd-to-wrd-hi-en.txt1  2>> $1/phrasal_error
...
#	python align-left-over-wrds.py  $1/wrd-to-wrd-hi-en.txt1  $1/hnd  $1/left-hi-en $1/left-over-words-hi-en.dat $1/align_left_over_wrds-hi-en.dat > $1/wrd-to-wrd-hi-en.dat 2>> $1/phrasal_error
	python3 mapping.py $1/wrd-to-wrd-hi-en.txt1 > $1/mapped1-hi-en.dat 2>> $1/phrasal_error
