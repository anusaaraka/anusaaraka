...
python match_value_in_hnd.py  $2  $MYPATH/tmp/$3_tmp/key-val-hi-en-hi.txt $MYPATH/tmp/$3_tmp/graph-hi-en-hi $1 > $MYPATH/tmp/$3_tmp/match-value-hi-en-hi.txt 
echo "Phrase alignment"
python print_shortest_path.py $MYPATH/tmp/$3_tmp/match-value-hi-en-hi.txt  $MYPATH/tmp/$3_tmp/graph-hi-en-hi > $MYPATH/tmp/$3_tmp/shortest-path-value-hi-en-hi.txt
python get_phrase.py  $2  $MYPATH/tmp/$3_tmp/shortest-path-value-hi-en-hi.txt $MYPATH/tmp/$3_tmp/left-over-words-hi-en-hi.txt > $MYPATH/tmp/$3_tmp/align_eng-hi-en-hi.txt
