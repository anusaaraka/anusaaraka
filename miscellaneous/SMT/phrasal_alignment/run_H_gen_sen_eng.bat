 ...
 (save-facts "database_original_mng.dat" local database_info tam_database_info)
 (clear)
 ;--------------------------------------------------------------------------
 (load "global_path.clp")
...
; (load-facts "hindi_meanings.dat")
; (open "database_mng.dat" dic_fp1 "a")
...
; (save-facts "alignment_source.dat" local man_id-root-src-rule_name)
...
;;(open "word_alignment.dat" dic_fp1 "w")
; (open "alignment_source.dat" dic_fp2 "a")
; (open "man_aligned_ids_tmp.dat" "a")
...
; (load-facts "manual_id_mapping.dat")
 ...
 (assert (anu_verb_count-verbs 0))
 (assert (man_verb_count-verbs 0))
 (assert (heuristics anu_exact_match anu_word_match_without_vib dic_word_match dic_word_match_without_vib dic_root_match_without_vib dic_root_match hindi_wordnet_match single_verb_match english_word_match transliteration_match M_layer_pharasal_match L_layer_pharasal_match))
 (open "slot_debug_input.txt" s_fp "a")
 (run)
 (save-facts "slot_debug_source.dat" local anu_id-man_id-root-src-rule_name no_match_found)
 (close s_fp)
 ;--------------------------------------------------------------------------
 (load "global_path.clp")
 ...
 (load-facts "manual_word.dat")
 (load-facts "id_Apertium_output.dat")
 (load-facts "slot_debug_source.dat")
 (load-facts "manual_lwg.dat")
 (assert (heuristic-weightage anu 4))
 (assert (heuristic-weightage hindi_wordnet 3))
 (assert (heuristic-weightage dictionary 3))
 (assert (heuristic-weightage single_verb_match 2))
