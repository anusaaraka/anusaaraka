...
; (clear)
 ...
 (assert (anu_verb_count-verbs 0))
 (assert (man_verb_count-verbs 0))
 (assert (heuristics anu_exact_match anu_word_match_without_vib dic_word_match dic_word_match_without_vib dic_root_match_without_vib dic_root_match hindi_wordnet_match single_verb_match kriyA_mUla_partial_match english_word_match transliteration_match M_layer_pharasal_match L_layer_pharasal_match))
