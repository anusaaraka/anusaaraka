...
; (clear)
 ...
 ;--------------------------------------------------------------------------
 (load "global_path.clp")
 (bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/phrasal_alignment/hnd_and_std_rels_alignment.clp"))
 (load ?*path*)
 (load-facts "left_over_ids.dat")
 (load-facts "manual_lwg.dat")
 (load-facts "man_hnd_parser_rels1.dat")
 (load-facts "relations_tmp1.dat")
 ...
 (run)
 (save-facts "final_word_alignment.dat" local final_align)
 (clear)
 (exit)
