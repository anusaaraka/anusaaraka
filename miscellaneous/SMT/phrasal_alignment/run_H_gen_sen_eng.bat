...
; (clear)
 ...
 (assert (anu_verb_count-verbs 0))
 (assert (man_verb_count-verbs 0))
 (assert (heuristics anu_exact_match anu_exact_match_without_vib anu_root_match multi_dictionary_match dictionary_match dictionary_match_without_vib multi_hindi_wordnet_match hindi_wordnet_match single_verb_match kriyA_mUla_partial_match hnd_and_std_rel_match partial_match hindi_tam_match hindi_tam_dic_match english_word_match transliteration_match scope manual_scope M_layer_pharasal_match L_layer_pharasal_match))
...
; (assert (heuristic-weightage manual_scope 4))
 (assert (heuristic-weightage L_layer_pharasal_match 1.4))
 (assert (heuristic-weightage M_layer_pharasal_match 1.4))
