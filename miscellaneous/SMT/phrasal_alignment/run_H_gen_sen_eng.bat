...
; (clear)
 ...
 (assert (heuristics anu_exact_match anu_exact_match_without_vib anu_partial_match dictionary_match dictionary_match_without_vib hindi_wordnet_match single_verb_match kriyA_mUla_partial_match hindi_tam_match english_word_match transliteration_match scope M_layer_pharasal_match L_layer_pharasal_match))
