...
; (clear)
 ...
 (load-facts "comp_and_aux_grp_info.dat")
 (open "align_percent_info.dat" a_fp "w")
 (run)
...
; (clear)
 ...
 (assert (heuristic-weightage hindi_wordnet_match 3))
 ...
 (assert (heuristic-weightage L_layer_pharasal_match 1.5))
 (assert (heuristic-weightage M_layer_pharasal_match 1.5))
; (assert (heuristic-weightage parsers_match 0.5))
 (run)
