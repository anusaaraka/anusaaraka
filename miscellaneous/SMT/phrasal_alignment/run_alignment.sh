...
cd $1
sh $MYPATH/sriram/sriram.sh match-value.dat
cd $MYPATH
echo "Word alignment" >> $1/phrasal_error
python get_word_align.py Word-to-Word-dict.txt   $1/mapped-new.dat $1/hnd $1/left > $1/wrd-to-wrd.txt1 2>> $1/phrasal_error
