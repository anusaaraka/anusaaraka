...
python get_phrase.py  $2 $MYPATH/tmp/$3_tmp/graph  $MYPATH/tmp/$3_tmp/match-value.txt $MYPATH/tmp/$3_tmp/align_eng.txt $MYPATH/tmp/$3_tmp/left-over-words.txt
...
sed -i 's/++++/\//g' $MYPATH/tmp/$3_tmp/wrd-to-wrd.txt
