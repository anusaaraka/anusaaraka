...
python3 $HOME_anu_test/miscellaneous/SMT/phrasal_alignment/align_debug/print_dependency_matrix.py dependency_debug_input.txt eng_parser_grp_rel_ids.dat eng_parser_grp_rel_wrds.dat hindi_parser_grp_rel_ids.dat hindi_parser_grp_rel_wrds.dat > $1_table
