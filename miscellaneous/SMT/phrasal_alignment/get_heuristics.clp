...
(not (anu_id-man_id-src-rule_name ?eid ?mid ? verb_root_and_tam_match_using_dic))
(not (anu_id-man_id-src-rule_name ?eid ?mid ? verb_match_with_WSD))
(not (anu_id-man_id-src-rule_name ? ?mid ? anu_exact_match))
(not (anu_id-man_id-src-rule_name ? ?mid ? anu_exact_match1))
