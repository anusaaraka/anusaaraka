...
java -mx300m -cp "`dirname $0`/stanford-tregex-2018-10-16/stanford-tregex.jar:`dirname $0`/stanford-tregex-2018-10-16/lib/*:" edu.stanford.nlp.trees.tregex.gui.TregexGUI $HOME_anu_test/miscellaneous/std_tregex/$1_output
