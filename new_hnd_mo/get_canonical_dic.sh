...
$HOME_anu_test/Anu_data/canonical_form_dictionary/canonical_form_correction.out  <  apertium_hn_in_canonical_form.dix_tmp1 > apertium_hn_in_canonical_form.dix
