...
for i in range(0, len(dire)):
    ...
    #		print '===========', char[-50:] , char[x:k],  ''.join(char),
            try:
                ...
                print("********* Error in sentence no: " +
                      dire[i] + " Pls check the sentence. *********")
            ...
            if "WSD" not in source:
                ...
                # Added below loop to access provisional multi word by Roja(21-02-14)
                    ...
                    dic2.append(
                        "Anu_data/compound-matching/provisional_multi_word_dictionary.txt")
                    if dic2[0] not in check:
                        check.append(dic2[0])
                        dic1.append(dic2)
                # Added below loop to access physics multi word by Roja(12-11-14)
                    ...
                    dic2.append(
                        "miscellaneous/SMT/MINION/dictionaries/phy_eng_multi_word_dic.txt")
                    if dic2[0] not in check:
                        check.append(dic2[0])
                        dic1.append(dic2)
                # Added below loop to access agriculture multi word by Roja(12-11-14)
                    ...
                    dic2.append(
                        "Anu_data/domain/multi_word_dic/agriculture_multi_dic.txt")
                    if dic2[0] not in check:
                        check.append(dic2[0])
                        dic1.append(dic2)
                # Added below loop to access mixed domain dic by Roja(12-01-16)
                    ...
                    dic2.append(
                        "Anu_data/canonical_form_dictionary/dictionaries/mixed_domain_dic_in_canonical_form.txt")
                    if dic2[0] not in check:
                        check.append(dic2[0])
                        dic1.append(dic2)
    ...
    #		print '===========', char[-50:] , char[x:k],  ''.join(char),
        ...
        for j in range(0, len(dic1)):
            ...
            if(j != len(dic1)-1 and dic1[j][0] == dic1[j+1][0]):
                tmp = []
                # Modified by Roja(04-04-16) 'tam' to '_tam' Counter Ex: stamp.
                val = dic1[j+1][1].find("_tam")
                if(val != -1):
                    tmp.append(dic1[j][1])
    ...
    #				print '==========', dic1[j], '******', j, dic1, '______', tmp, ''.join(char),
        ...
        print(
            "Failed to create debugging files from this sentence onwards.\nPls check the sentence." + dire[i])
        os.chdir("..")
f1.close()
