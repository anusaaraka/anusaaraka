...
$HOME_anu_test/Anu_src/replace_nonascii-chars.out $2/tmp/$1_tmp/$1_tmp1.html $2/tmp/$1_tmp/$1.html
$HOME_anu_test/Anu_src/replace_nonascii-chars.out $2/tmp/$1_tmp/$1_tran_tmp1.html $2/tmp/$1_tmp/$1_tran.html
...
$HOME_anu_test/Anu_src/replace_nonascii-chars.out $2/tmp/$1_tmp/$1_trnsltn_tmp2.html $2/tmp/$1_tmp/$1_trnsltn.html
