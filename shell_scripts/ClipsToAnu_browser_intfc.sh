...
sed 's/@SYMBOL/SYMBOL/g'  $2/tmp/$1_tmp/$1_tmp2.html   | sed "s/\([_>'\"]\)SYMBOL/\1 SYMBOL/g" | sed "s/SYMBOL-\([A-Z0-9\-]*\)\([^<\"]\)/SYMBOL-\1\2/g" | sed "s/SYMBOL-\([A-Z0-9\-]*\)\([<\"]\)/SYMBOL-\1 \2/g" | sh Symbols.sh  > $2/tmp/$1_tmp/$1_tmp3.html
sed 's/@SYMBOL/SYMBOL/g'  $2/tmp/$1_tmp/$1_tran_tmp2.html | sed "s/\([_>'\"]\)SYMBOL/\1 SYMBOL/g" | sed "s/SYMBOL-\([A-Z0-9\-]*\)\([^<\"]\)/SYMBOL-\1\2/g" | sed "s/SYMBOL-\([A-Z0-9\-]*\)\([<\"]\)/SYMBOL-\1 \2/g" | sh Symbols.sh  > $2/tmp/$1_tmp/$1_tran_tmp3.html
