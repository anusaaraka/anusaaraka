...
#Replacing SYMBOL1 , SYMBOL2 etc with original Symbols. 
...
$HOME_anu_test/Anu_src/replace_nonascii-chars.out $2/tmp/$1_tmp/$1_trnsltn_tmp2.html $2/tmp/$1_tmp/$1_trnsltn_tmp3.html
