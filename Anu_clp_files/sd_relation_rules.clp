...
;------------------------------------------------------------------------------------------------------------------------
 ...
 (printout       ?*fp*   "(using-parser-ids    kriyA-aBihiwa       "?kriyA"        "?GNP_sub   ")"crlf)
...
(printout       ?*dbug* "(Rule-Rel-ids  nsubj_conj1  kriyA-subject  "?kriyA"        "?sub1   ")"crlf)
 ...
 =>
  (printout       ?*fp*   "(using-parser-ids     subject-subject_samAnAXikaraNa   "?sub"  "?and        ")"crlf)      
...
=>
(printout       ?*fp*   "(using-parser-ids     kriyA-vAkyakarma         "?vAkyakarma "   "?kriyA")"crlf)
...
=>
(printout       ?*fp*   "(using-parser-ids     object-object_samAnAXikaraNa     "?obj"        "?obj_s   ")"crlf)
...
;------------------------------------------------------------------------------------------------------------------------
 ...
 (rel_name-sids  poss  ?RaRTI_viSeRya ?RaRTI1)
...
=>
(printout       ?*fp*   "(using-parser-ids     viSeRya-viSeRaka     "?viSeRya"        "?viSeRaka        ")"crlf)      
...
(not (parserid-word ?kriyA many))
=>
(printout       ?*fp*   "(using-parser-ids     kriyA-aXikaraNavAcI_avyaya     "?kriyA"        "?lupwa_prep_saMbanXI        ")"crlf)      
...
=>
 (printout       ?*fp*   "(using-parser-ids     viSeRaNa-viSeRaka "?viSeRya"      "?viSeRaNa      ")"crlf)
...
=>
(printout       ?*fp*   "(using-parser-ids     kriyA-conjunction        "?x"      "?conj      ")"crlf)
...
=>
(printout       ?*fp*   "(using-parser-ids     kriyA-preraka_kriyA   "       ?kri"    "?pre_kri")"crlf)
...
(parserid-word  ?pre_kri made|make|makes|has|have|had)
=>
(printout       ?*fp*   "(using-parser-ids     kriyA-prayojya_karwA   "       ?kri"    "?pra_karwA")"crlf)
