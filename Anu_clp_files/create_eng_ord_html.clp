...
; )
 ...
 (deffunction print_seventh_row(?p_id ?s_id ?w_id ?chnk_fr_htm ?l_punc ?r_punc ?padasuthra ?h_tam ?id_type)
 ...
 (deffunction print_eigth_row(?p_id ?s_id ?w_id ?chnk_fr_htm ?l_punc ?r_punc ?h_mng ?h_tam ?id_type)
 ...
 (deffunction print_ninth_row(?p_id ?s_id ?w_id ?chnk_fr_htm ?l_punc ?r_punc ?h_mng ?h_tam ?id_type ?sign)
 ...
 (deffunction print_tenth_row(?p_id ?s_id ?w_id ?chnk_fr_htm ?l_punc ?r_punc ?aper_op ?lwg_type)
 ...
 (deffunction print_eleventh_row(?p_id ?s_id ?w_id ?chnk_fr_htm ?l_punc ?r_punc ?aper_op ?id_type)
 ...
 (print_first_row  1 1 1 ?chnk_fr_htm ?l_punc ?r_punc ?root ?original_word ?sen_type ?fetch)
 (print_second_row 1 1 1 ?chnk_fr_htm ?l_punc ?r_punc ?root ?sen_type ?idiom_des)
 (print_third_row  1 1 1 ?chnk_fr_htm ?l_punc ?r_punc ?root)
 (print_fourth_row 1 1 1 ?chnk_fr_htm ?l_punc ?r_punc ?cat)
 (print_fifth_row  1 1 1 ?chnk_fr_htm ?chunk_type)
 (print_sixth_row  1 1 1 ?chnk_fr_htm ?l_punc ?r_punc ?padasuthra)
 (print_seventh_row  1 1 1 ?chnk_fr_htm ?l_punc ?r_punc - - -)
 (print_eigth_row  1 1 1 ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - -)
 (print_ninth_row  1 1 1 ?chnk_fr_htm ?l_punc ?r_punc  - - - -)
 (print_tenth_row  1 1 1 ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output -)
 (print_eleventh_row  1 1 1 ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output -)
 ...
 (bind ?fetch (sub-string 0 1 (implode$ (create$ ?root))))
 (printout fp "<form class=\"suggestion\" action=\"sumbit_suggestions.php\"><table cellspacing=\"0\">" crlf)
 (print_first_row  ?p_id ?s_id 1 ?chnk_fr_htm ?l_punc ?r_punc ?root ?original_word ?sen_type ?fetch)
 ...
 (if (eq ?l_punc "NONE") then (bind ?l_punc ""))
 (bind ?idiom_des (gdbm_lookup "idioms.gdbm" ?phrase))
 (print_second_row ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?root ?sen_type ?idiom_des)
 (print_third_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?root)
 (print_fourth_row ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?cat)
 (print_fifth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?chunk_type)
 (print_sixth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?padasuthra)
 (if (= ?head_id ?id) then
 (print_seventh_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?h_tam ?padasuthra MAIN_VERB)
 ...
 (print_fifth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?chunk_type)
 (print_sixth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?padasuthra)
 (print_seventh_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - ?padasuthra VIB0) 
 (print_eigth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - VIB0)
 (print_ninth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - VIB0 -)
 (print_tenth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output -)
 (print_eleventh_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output -)
 ...
 (if (eq ?l_punc "NONE") then (bind ?l_punc ""))
 (bind ?idiom_des (gdbm_lookup "idioms.gdbm" ?phrase))  
 (print_second_row ?p_id ?s_id ?pp_id ?chnk_fr_htm ?l_punc ?r_punc ?pp_root ?sen_type ?idiom_des)
 (print_third_row  ?p_id ?s_id ?pp_id ?chnk_fr_htm ?l_punc ?r_punc ?pp_root)
 (print_fourth_row ?p_id ?s_id ?pp_id ?chnk_fr_htm ?l_punc ?r_punc ?pp_cat)
 (print_fifth_row  ?p_id ?s_id ?pp_id ?chnk_fr_htm ?chunk_type)
 (print_sixth_row  ?p_id ?s_id ?pp_id ?chnk_fr_htm ?l_punc ?r_punc ?pp_padasuthra)
 (print_seventh_row  ?p_id ?s_id ?pp_id ?chnk_fr_htm ?l_punc ?r_punc - ?pp_padasuthra -)
 (if (> ?sign 0) then
 (print_eigth_row  ?p_id ?s_id ?pp_id ?chnk_fr_htm ?l_punc ?r_punc ?pp_h_mng - GREATER_THAN)
 (print_ninth_row  ?p_id ?s_id ?pp_id ?chnk_fr_htm ?l_punc ?r_punc ?pp_h_mng - GREATER_THAN ?sign)
 else
 (print_eigth_row  ?p_id ?s_id ?pp_id ?chnk_fr_htm ?l_punc ?r_punc ?pp_h_mng - LESS_THAN)
 (print_ninth_row  ?p_id ?s_id ?pp_id ?chnk_fr_htm ?l_punc ?r_punc ?pp_h_mng - LESS_THAN ?sign))
 (print_tenth_row  ?p_id ?s_id ?pp_id ?chnk_fr_htm ?l_punc ?r_punc "~" -)
 (print_eleventh_row  ?p_id ?s_id ?pp_id ?chnk_fr_htm ?l_punc ?r_punc "~" -) 
 ...
 (print_fifth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?chunk_type)
 (print_sixth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?padasuthra)
 (print_seventh_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - ?padasuthra -)
 (print_eigth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - -)
 (print_ninth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - - -)
 (print_tenth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output -)
 (print_eleventh_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?apertium_output -)
 ...
 (print_eigth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - -)
 (print_ninth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?h_mng - - -)
 (print_tenth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?h_mng -)
 (print_eleventh_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?h_mng -)
 ...
 (print_sixth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?padasuthra)
 (print_seventh_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - ?padasuthra -)
 (print_eigth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - - -)
 (print_ninth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - - - -)
 (print_tenth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - -)
 (print_eleventh_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - -)
 ...
 (if (eq ?r_punc "NONE") then (bind ?r_punc ""))
 (if (eq ?l_punc "NONE") then (bind ?l_punc ""))
 (print_second_row ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - - -s)
 (print_third_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc ?word)
 (print_fourth_row ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc -)
 (print_fifth_row  ?p_id ?s_id ?id ?chnk_fr_htm -)
 (print_sixth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc -)
 (print_seventh_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - - -)
 (print_eigth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - - -)
 (print_ninth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - - - -)
 (print_tenth_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - -)
 (print_eleventh_row  ?p_id ?s_id ?id ?chnk_fr_htm ?l_punc ?r_punc - -)
