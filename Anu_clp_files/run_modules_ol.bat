 ...
 (open "relations_id_map_debug.dat" rel_debug "w")
...
; Generate hindi Pada for the sentence.
 ...
 (load-facts "ol_resid_wordid_mapping.dat")
 (open "pada_info_debug.dat" pada_info_debug "w")
...
; ;================================ TRANSFER MODULE ===================================================
 ...
 (load-facts "debug_file.dat")
 ;(open "hindi_meanings_tmp1.dat" caus_mng_fp "a")
...
; (clear)
 ...
 (open "hindi_punctuation.dat" h_punc_fp "w")
 (run)
