 ...
 =>
        (retract ?f0 ?f1)
        (assert (parser_id-root  ?lid  ?root1 ?root2))
        (printout ?*pre_morph_fp* "(parser_id-root-category-suffix-number  "?lid"  "?root1  " "  ?root2"  "?cat" "?suf1 " " ?num1 ")" crlf)
       (printout ?*root_fp*  "(parser_id-root "?lid" "?root1   " " ?root2")" crlf)
 )
 ;-----------------------------------------------------------------------------------------------------------------------
;Some people take a lot of time to acclimatize themselves to the new environment.
 (defrule samAsa_root_2
 (declare (salience 60))
 (parserid-wordid ?lid ?id1 ?id2 ?id3)
 (id-original_word ?id1 ?word1)
 (id-original_word ?id2 ?word2)
 ...
 =>
        (retract ?f0 ?f1 ?f2)
        (assert (parser_id-root  ?lid  ?root1 ?root2 ?root3))
        (printout ?*pre_morph_fp* "(parser_id-root-category-suffix-number  "?lid"  "?root1 " "?root2" "?root3 " "?cat" "?suf1 " " ?num1 ")" crlf)
        (printout ?*root_fp*  "(parser_id-root "?lid" "?root1 " "?root2" "?root3")" crlf)
 )
 ;-----------------------------------------------------------------------------------------------------------------------
 ;He gave up his lucrative law practice for the sake of the country.
 (defrule samAsa_root_3
 (declare (salience 60))
 (parserid-wordid ?lid ?id1 ?id2 ?id3 ?id4)
 (id-original_word ?id1 ?word1)
 (id-original_word ?id2 ?word2)
 (id-original_word ?id3 ?word3)
 ...
 =>
        (retract ?f0 ?f1 ?f2 ?f3)
        (assert (parser_id-root  ?lid  ?root1 ?root2 ?root3 ?root4))
        (printout ?*pre_morph_fp* "(parser_id-root-category-suffix-number  "?lid"  "?root1 " "?root2" "?root3 " "?root4 "  "?cat" "?suf1 " " ?num1 ")" crlf)
        (printout ?*root_fp*  "(parser_id-root "?lid" "?root1 " "?root2" "?root3" "?root4")" crlf)
 )
 ;-----------------------------------------------------------------------------------------------------------------------
;Keep on the right side of the road.
(defrule samAsa_root_3
 (declare (salience 60))
 (parserid-wordid ?lid ?id1 ?id2 ?id3 ?id4 ?id5)
 (id-original_word ?id1 ?word1)
 (id-original_word ?id2 ?word2)
 (id-original_word ?id3 ?word3)
 (id-original_word ?id4 ?word4)
 ...
 =>
        ...
        (assert (parser_id-root  ?lid  ?root1 ?root2 ?root3 ?root4 ?root5))
        (printout ?*pre_morph_fp* "(parser_id-root-category-suffix-number  "?lid"  "?root1 " "?root2" "?root3 " "?root4 " "?root5 " "?cat" "?suf1 " " ?num1 ")" crlf)
        (printout ?*root_fp*  "(parser_id-root "?lid" "?root1 " "?root2" "?root3" "?root4" "?root5")" crlf)
 )
 ;-----------------------------------------------------------------------------------------------------------------------
 ...
 =>
        (retract ?f0 ?f1)
        (assert (parser_id-root ?lid ?word1))
        (assert (parser_id-root ?lid ?word2))
        (printout ?*pre_morph_fp* "(parser_id-root-category-suffix-number  "?lid"  "?word1" "?word2" PropN   -     -)" crlf)
        (printout ?*root_fp*  "(parser_id-root "?lid" "?word1" "?word2")" crlf)
 )
 ;-----------------------------------------------------------------------------------------------------------------------
