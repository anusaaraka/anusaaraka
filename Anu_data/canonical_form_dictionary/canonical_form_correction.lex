...
/* Ex: maMgavA in canonical form becomes mafgavA . */
/* So correcting canonical form here 'f' with 'z'	*/
...
mafgavA	{	printf("mazgavA");	/* mafgavA  becomes mazgavA */ 	}
UFcAI	{	printf("UzcAI");	/* UFcAI    becomes UzcAI   	}
KIFc	{	printf("KIzc");		KIFca    becomes KIzca   	}
arefg	{	printf("arezg");	karefge  becomes karezge 	}
\>efg	{	printf(">ezg");		xeKefge  becomes xeKezge 	}
xeKefg	{	printf("xeKezg");	xeKefge  becomes xeKezge 	}
