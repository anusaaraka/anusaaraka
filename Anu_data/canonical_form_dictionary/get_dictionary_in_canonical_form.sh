...
#	./get_canonical_form-dic.out  $line".hindi" > $line".canonical_form_tmp"
	$HOME_anu_test/Anu_data/canonical_form_dictionary/non_canonical_form.out   < $line".hindi" > $line".canonical_form_tmp-1"  
	./canonical_form.out <  $line".canonical_form_tmp-1" > $line".canonical_form_tmp"
	...
	rm $line".txt" $line".hindi" $line".eng" $line".canonical_form" $line".canonical_form_tmp" $line".canonical_form_tmp1" $line".canonical_form_tmp-1"
...
#	./get_canonical_form-dic.out  $line".hindi" > $line".canonical_form_tmp"
	...
	./canonical_form.out <  $line".canonical_form_tmp-1" > $line".canonical_form_tmp"
        ...
        rm $line".txt" $line".eng" $line".hindi" $line".canonical_form" $line".canonical_form_tmp" $line".canonical_form_tmp1" $line".canonical_form_tmp-1"
        echo "Generated $line"_in_canonical_form.txt"" 
done < list-right
###########################################
...
#        ./get_canonical_form-dic.out  $line".hnd"   > $line".hnd1.canonical_form_tmp"
	$HOME_anu_test/Anu_data/canonical_form_dictionary/non_canonical_form.out   < $line".hnd" > $line".hnd1.canonical_form_tmp-1"
        ./canonical_form.out <  $line".hnd1.canonical_form_tmp-1"   > $line".hnd1.canonical_form_tmp"
#        ./get_canonical_form-dic.out  $line".hindi" > $line".hnd2.canonical_form_tmp"
	$HOME_anu_test/Anu_data/canonical_form_dictionary/non_canonical_form.out   < $line".hindi" > $line".hnd2.canonical_form_tmp-1"
        ./canonical_form.out <  $line".hnd2.canonical_form_tmp-1" > $line".hnd2.canonical_form_tmp"
	...
	rm $line".txt" $line".hnd" $line".hindi" $line".hnd1.canonical_form" $line".hnd2.canonical_form" $line".hnd1.canonical_form_tmp" $line".hnd2.canonical_form_tmp" $line".hnd1.canonical_form_tmp1" $line".hnd2.canonical_form_tmp1" $line".hnd1.canonical_form_tmp-1" $line".hnd2.canonical_form_tmp-1"
	echo "Generated $line"_in_canonical_form.txt""
...
python3 $HOME_anu_test/Anu_src/unique_entries.py mixed_domain_dic_in_canonical_form.tmp2 mixed_domain_dic_in_canonical_form.txt
