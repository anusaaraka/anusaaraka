...
for i in f.readlines():
    ...
    if ' then ' in i:
        ...
        sent_wrds = i.split()
        sent = i
    for each in range(len(sent_wrds)):
        if sent_wrds[each] in tr_wrds:
            ...
            s = subprocess.getoutput(
                "sh $HOME_anu_test/bin/stanford_pos.sh jnk")
            ss = s.split('\n')
            pos = ss[2]
    ss = pos.split()
        ...
        if 'her_PRP' in ss[j] or 'Her_PRP' in ss[j] or 'like_VBP' in ss[j]:
            ...
            for k in range(len(strng)):
                ...
                if a[0] == 'her' and a[1] == 'PRP$':
                    ss[j] = 'his_PRP$'
                    wt.write(
                        "(id-original_word-transformed_word\t%s\ther\this)\n" % (j+1))
                    file_p = 1
                if a[0] == 'Her' and a[1] == 'PRP$':
                    ss[j] = 'His_PRP$'
                    wt.write(
                ...
                if a[0] == 'her' and a[1] == 'PRP':
                    ...
                    file_p = 1
                    wt.write(
                        "(id-original_word-transformed_word\t%s\ther\thim)\n" % (j+1))
                if a[0] == 'Her' and a[1] == 'PRP':
                    ss[j] = 'Him_PRP'
                    file_p = 1
                    wt.write(
                ...
                if a[0] == 'like' and a[1] == 'VBP':
                    ...
                    file_p = 1
                    wt.write(
                        "(id-original_word-transformed_word\t%s\tlike\tlove)\n" % (j+1))
    tr_sent = ''
    for each in range(len(ss)):
        st = ss[each].split('_')
