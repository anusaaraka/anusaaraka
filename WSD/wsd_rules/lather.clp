...
;He was in lather when asked to deliver his maiden speech. [OLD]
;vaha uwwejiwa avasWA meM WA jaba use usakA pahalA BASaNa xene ke liye kahA.
(defrule lather2
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id uwwejiwa_avasWA))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  lather.clp 	lather2   "  ?id "  uwwejiwa_avasWA )" crlf))
)
