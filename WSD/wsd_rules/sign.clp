...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " sign.clp	sign0  "  ?id "  " ?id1 "  kArya_keliye_saMJowA_kara  )" crlf))
)
