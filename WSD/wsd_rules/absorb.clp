...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " absorb.clp	absorb0  "  ?id "  " ?id1 "  meM_magna_ho  )" crlf))
)
...
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 meM_magna_ho))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " absorb.clp	absorb5  "  ?id "  " ?id1 "  meM_magna_ho  )" crlf))
)
