...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " tamper.clp	tamper0  "  ?id "  " ?id1 "  meM_haswakRepa_kara  )" crlf))
)
...
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 meM_haswakRepa_kara))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " tamper.clp	tamper1  "  ?id "  " ?id1 "  meM_haswakRepa_kara  )" crlf))
)
...
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 meM_haswakRepa_kara))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " tamper.clp	tamper2  "  ?id "  " ?id1 "  meM_haswakRepa_kara  )" crlf))
)
