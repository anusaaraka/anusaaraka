...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id sImA_para_ho));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " border.clp border0 " ?id "  sImA_para_ho )" crlf)) 
)
