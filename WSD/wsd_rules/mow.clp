...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " mow.clp	mow2  "  ?id "  " ?id1 "  mAra_dAla  )" crlf))
)
...
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 mAra_dAla))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " mow.clp	mow3  "  ?id "  " ?id1 "  mAra_dAla  )" crlf))
)
...
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 mAra_dAla))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " mow.clp	mow4  "  ?id "  " ?id1 "  mAra_dAla  )" crlf))
)
