...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id kisI_ko_prowsAhiwa_kara));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " ginger.clp ginger1 " ?id "  kisI_ko_prowsAhiwa_kara )" crlf)) 
)
...
(assert (id-wsd_root_mng ?id kisI_ko_prowsAhiwa_kara));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " ginger.clp ginger2 " ?id "  kisI_ko_prowsAhiwa_kara )" crlf)) 
)
...
(assert (id-wsd_root_mng ?id kisI_ko_prowsAhiwa_kara));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " ginger.clp ginger3 " ?id "  kisI_ko_prowsAhiwa_kara )" crlf)) 
)
