...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id kisI_burI_cIjZa_ko_svayaM_se_xUra_raKa));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
