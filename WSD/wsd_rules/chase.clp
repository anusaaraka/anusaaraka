...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " chase.clp	chase0  "  ?id "  " ?id1 "  BagA_xe  )" crlf))
)
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id piCA))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  chase.clp 	chase2   "  ?id "  piCA )" crlf))
)
