...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id bila_Barakara_jagaha_KAlI_kara));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " checked.clp checked0 " ?id "  bila_Barakara_jagaha_KAlI_kara )" crlf)) 
)
...
(assert (id-wsd_root_mng ?id bila_Barakara_jagaha_KAlI_kara));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " checked.clp checked3 " ?id "  bila_Barakara_jagaha_KAlI_kara )" crlf)) 
)
