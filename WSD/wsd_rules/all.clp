...
;$$$ Modified by Shirisha Manju Suggested by Chaitanya Sir (11-12-13) added they|you|us|them|we in the list and used root fact insteadof word fact.
(defrule all0
(declare (salience 4000))
(id-root ?id all)
?mng <-(meaning_to_be_decided ?id)
(id-root =(- ?id 1) be|they|you|us|them|we)
=>
(retract ?mng)
