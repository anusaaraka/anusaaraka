...
(assert (id-wsd_root_mng ?id sagA))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " sub_samA_biological0" ?id " sagA )" crlf))
)
...
(assert (id-wsd_root_mng ?id sagA))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " obj_samA_biological0" ?id " sagA )" crlf))
)
