...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " flood.clp	flood1  "  ?id "  " ?id1 "  bADZa_se_praBAviwa  )" crlf))
)
...
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 bADZa_se_praBAviwa))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " flood.clp	flood4  "  ?id "  " ?id1 "  bADZa_se_praBAviwa  )" crlf))
)
