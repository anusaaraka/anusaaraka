...
(assert (id-wsd_root_mng ?id upalabXi))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " performance.clp   sub_samA_performance0   "   ?id " upalabXi )" crlf))
)
...
(assert (id-wsd_root_mng ?id upalabXi))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " performance.clp   obj_samA_performance0   "   ?id " upalabXi )" crlf))
)
