...
(assert (id-wsd_root_mng ?id sistama_saMbanXI))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " sub_samA_systemic0" ?id " sistama_saMbanXI )" crlf))
)
...
(assert (id-wsd_root_mng ?id sistama_saMbanXI))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " obj_samA_systemic0" ?id " sistama_saMbanXI )" crlf))
)
