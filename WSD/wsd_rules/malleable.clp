...
(assert (id-wsd_root_mng ?id AsAnI_se_praBAviwa_hone_vAlA ))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name_id-wsd_root_mng " ?*wsd_dir* " malleable.clp   sub_samA_malleable1   "   ?id " AsAnI_se_ praBAviwa_hone_yA_baxalane_vAlA )" crlf))
)
...
(assert (id-wsd_root_mng ?id AsAnI_se_praBAviwa_hone_vAlA ))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name_id-wsd_root_mng " ?*wsd_dir* " malleable.clp   obj_samA_malleable1   "   ?id " AsAnI_se_ praBAviwa_hone_yA_baxalane_vAlA )" crlf))
)
