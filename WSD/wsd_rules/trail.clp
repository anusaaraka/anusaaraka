...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " trail.clp	trail0  "  ?id "  " ?id1 "  kisI_kI_AvAja_kA_XIre_XIre_kama_ho  )" crlf))
)
...
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 kisI_kI_AvAja_kA_XIre_XIre_kama_ho))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " trail.clp	trail1  "  ?id "  " ?id1 "  kisI_kI_AvAja_kA_XIre_XIre_kama_ho  )" crlf))
)
...
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 kisI_kI_AvAja_kA_XIre_XIre_kama_ho))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-affecting_id-affected_ids-wsd_group_root_mng   " ?*wsd_dir* " trail.clp	trail2  "  ?id "  " ?id1 "  kisI_kI_AvAja_kA_XIre_XIre_kama_ho  )" crlf))
)
