...
3. source ~/.bashrc
4. cd $HOME_anu_test/Parsers/ace-parser/LINGO
5. sh install.sh $HOME_anu_test/Parsers/ace-parser/LINGO/delphin
6. cd $HOME_anu_test/Parsers/ace-parser/
7. tar -xvzf ace-0.9.19-x86-64.tar.gz
