 cd $HOME_anu_test/Parsers/rasp-parser/rasp3os/scripts/
 ...
 do
 cd $1/tmp/$2_tmp/$line
 $HOME_anu_test/Parsers/rasp-parser/src/rasp_constituency_parse $1/tmp/$2_tmp/$line/rasp_constituents_info.dat $1/tmp/$2_tmp/$line/rasp_node_category_info.dat < $1/tmp/$2_tmp/$line/rasp_constituents
