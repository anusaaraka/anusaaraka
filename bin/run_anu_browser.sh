...
#Copied Browser related files from bottom of the code to top for the purpose of copying mail.js file. (This modification done by Roja 14-02-14)
 cd $1/Browser
 cp -r help/*htm $4/help/
 cd src
 cp style.css english_hindi.css script.js open.js english_hindi.js shabdanjali.js rows.html help.html popup.css effects.js prototype.js dragdrop.js popup.js cautions.js english_hindi_tran.js english_hindi_tran.css mail.js $4
