#/bin/sh
 ...
 do
    ...
    timeout 500 ./run_sentence_stanford_align_man.sh $1 $line 1 $MYPATH $4 $6
    echo ""
 ...
 sh $HOME_anu_test/miscellaneous/SMT/MINION/browser/run_align_browser_man.sh $HOME_anu_test $1 $MYPATH $HOME_anu_output
