...
cd $PATH1/$1_tmp/$2
perl $PATH2/debugging/make_freemind_stanford.pl  $PATH2/Anu_clp_files/run_modules_std.bat  > $PATH1/tmp_freemind/$1_debug_std.mm

freemind $PATH1/tmp_freemind/$1_debug_std.mm
