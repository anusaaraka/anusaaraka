 ...
 cat  para_sent_id_info.dat original_word.dat word.dat punctuation_info.dat sd_chunk.dat cat_consistency_check.dat padasuthra.dat root.dat  revised_preferred_morph.dat lwg_info.dat hindi_meanings_with_grp_ids.dat GNP_agmt_info.dat id_Apertium_output_with_grp.dat catastrophe.dat alignment1_debug.dat > facts_for_eng_html
 ...
 if [ "$4" == "general" ] ; then
	cat facts_for_eng_html English_sentence.dat word_alignment_tmp.dat word_alignment.dat parser_alignment.dat manual_hindi_sen.dat  >> facts_for_eng_align_html
 	...
 	cat facts_for_eng_html English_sentence.dat word-alignment.dat word-alignment-hi-en.dat word_alignment_tmp.dat word_alignment.dat parser_alignment.dat manual_hindi_sen.dat mapped3.dat mapped3-hi-en1.dat alignment1_debug.dat >> facts_for_eng_align_html
 fi
 ...
 cat suggested_mwe_mngs.dat >> $HOME_anu_tmp/tmp/$2_tmp/suggested_mwe_mngs_tmp.txt
