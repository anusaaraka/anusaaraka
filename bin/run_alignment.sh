 ...
 if ! [[ -a  mapped.dat ]] ; then
      touch  mapped.dat
 fi
 
 if ! [[ -a  mapped-hi-en.dat ]] ; then
      touch  mapped-hi-en.dat
 fi
 ...
 sed "s/position-eng-hnd-eng_ids/position_hi_en-eng-hnd-eng_ids/g" mapped-hi-en.dat > mapped-hi-en1.dat

 cat facts_for_eng_html English_sentence.dat word-alignment.dat word-alignment-hi-en.dat word_alignment_tmp.dat word_alignment_hi_en_tmp.dat manual_hindi_sen.dat mapped.dat mapped-hi-en1.dat >> facts_for_eng_align_html
