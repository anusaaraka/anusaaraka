...
# myclips -f $HOME_anu_test/Anu_clp_files/run_H_gen_sen.bat >> $1.error
 ...
 cat facts_for_eng_html English_sentence.dat word-alignment.dat word-alignment-hi-en.dat word_alignment_tmp.dat manual_hindi_sen.dat >> $MYPATH/$1_tmp/$2/facts_for_eng_align_html
