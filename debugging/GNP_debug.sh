 ...
 cp  word.dat English_sentence.dat global_path.clp GNP_debug.dat apertium_input_debug.dat id_Apertium_input.dat pada_id_info.dat  id_Apertium_output.dat $HOME_anu_test/debugging/sentence_debug/.
