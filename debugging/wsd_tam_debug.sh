...
cp meaning_to_be_decided.dat word.dat original_word.dat revised_root.dat relations.dat revised_preferred_morph.dat debug_file.dat global_path.clp cat_consistency_check.dat tam_id.dat hindi_tam_info.dat $HOME_anu_test/debugging/sentence_debug/.
