cp $HOME_anu_test/debugging/sentence_debug.clp $HOME_anu_test/debugging/run_sentence_debug.bat  $HOME_anu_test/debugging/sentence_debug/.
 ...
 cp global_path.clp word.dat English_sentence.dat parser_type.dat sd-relations_tmp.dat relations_tmp1.dat sd-relations_tmp.dat $HOME_anu_test/debugging/sentence_debug/.
