...
cp PropN.txt  adverbs_list.txt  uncountable.txt  inanimate.txt  animate.txt  plural_words.txt  ol_parser_unused_words.txt  place.txt  time.txt  eng-animate-list.txt  transitive-verb-list.txt  idioms.txt  preposition.txt  human.txt  $HOME_anu_test/debugging/provisional_Anu_databases/
