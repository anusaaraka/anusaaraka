 ...
 cp  meaning_to_be_decided.dat word.dat original_word.dat root.dat relations.dat lwg_info.dat cat_consistency_check.dat  meaning_has_been_decided.dat  preferred_morph.dat link_relation_info.dat link_name_expand.dat debug_file.dat hindi_meanings.dat global_path.clp compound_phrase.dat $HOME_anu_test/debugging/sentence_debug/.
