...
cat $MYPATH/proper_noun-common_noun_compounds_in_canonical_form.txt $MYPATH/acronyms-common_noun_compounds_in_canonical_form.txt $MYPATH/named_entities_in_canonical_form.txt  $MYPATH/proper_noun_organization_names_in_canonical_form.txt  $MYPATH/proper_noun_person_names_in_canonical_form.txt  $MYPATH/proper_noun_place_names_in_canonical_form.txt > proper_noun_dic.txt
