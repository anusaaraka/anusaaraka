...
//** Include provisional multi word dictionary (Removed 'char input_file []' instead included provisional multi word dictionary by Roja)
...
//	if (matchp->position >  par->position) { Commented by Roja and added below loop
